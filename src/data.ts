...
export const creatures: Creature[] = [
  ...
  },
  {
    ...
    moves: [{
      ...
      direction: "random", tension: 23, wrongTension: 32,
  ...
  },
  {
    ...
    moves: [
      { id: "bass-dart", kind: "run", eligibleAfter: [1.8, 2.8],
        ...
        direction: "random", tension: 24, wrongTension: 36, progressMultiplier: 0.7 },
      { id: "bass-reversal", kind: "run", eligibleAfter: [3, 4],
        telegraph: 0.65, duration: 2.85, reverseAt: 1.75, reverseReaction: 0.65,
        cooldown: [5, 7], recovery: 1, direction: "random", tension: 24,
        wrongTension: 36, progressMultiplier: 0.7, guaranteeBefore: 35 },
    ],
  },
  {
    id: "european-eel",
    ...
    moves: [
      { id: "eel-burst", kind: "directional-surge", eligibleAfter: [2, 3.5],
        ...
        direction: "random", tension: 28, wrongTension: 40, progressMultiplier: 0.7 },
...
export const assets = {
  ...
  harborNight: asset("environment/harbor-night.png"),

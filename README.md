...
The Perch uses exactly +13/s Catch Progress, −3/s on release, +16/s Tension, and −50/s on release. The Trout is a stronger Calm fight: +12/s Catch Progress, −5/s on release, +20/s Tension, and −46/s on release. Both use critical Tension at 90, maximum 100, and immediate line snap at maximum. Leaving Reel released at zero Catch Progress for three seconds lets the fish escape; the final 1.5 seconds show a warning. Pausing freezes this timer. Waiting is randomized 2–5 seconds; Hook lasts 0.9 seconds. Neither Creature has directional events or special attacks.
